...
class EnglishWordsTest:
    def __init__(self):
        ...
        with open(os.path.join(self.root_path, '../../[John]英语自测工具/basic', 'cet4.txt'), encoding='utf-8') as f:
    ...
    def clean_data(self, data):
        ...
        for num, line in enumerate(exam_data, start=1):
            ...
            <tr>
             ...
             '''.format(num, *line)
        with open(os.path.join(self.root_path, '../../[John]英语自测工具/basic', 'root.html'), encoding='utf-8') as f:
            data = f.read()
        with open(os.path.join(self.root_path, '../templates/exam.html'), 'w+', encoding='utf-8') as f:
